...
const Profile = ({
  ...
  const {id, dpSigned, dpLocation, dpSignaturePolicy} = member;
  ...
  console.log("dpSigned", dpSigned);
  console.log("dpSignatureType", dpSignatureType);
      ...
      >
        ...
        <DialogContent>
          <DialogContentText id="alert-dialog-description">
            ...
            { dpSigned && dpSignaturePolicy > 0 && t("DATA_PRIVACY_ON_DIGITAL") }
            { dpSigned && dpSignaturePolicy == 0 && t("DATA_PRIVACY_ON_CONTRACT") }
          </DialogContentText>
        </DialogContent>
        <DialogActions>
        {
