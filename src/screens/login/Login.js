      ...
      >
        <Root className={"scene"} style={{display: "table", height: "100vh", width: "100vw"}}>
          <div style={{
            ...
            <Grid centered columns={1} style={{height:"70vh", marginTop: "-13vh"}}>
              <Grid.Row centered columns={1}>
                <Transition from={{ marginTop: -300, opacity: 0 }} enter={{ marginTop: 0, opacity: 1 }} leave={{ marginTop: -300, opacity: 0 }} delay={300}>
                  {(styles => <LanistaLogo  style={styles}>
            ...
            <Transition from={{ bottom: -100 }} enter={{ bottom: 0 }} leave={{ bottom: -100 }} delay={300}>
              {(styles => <Footer style={styles}>
